...
unsigned off_p_gid = 0x2C; // proc_t::p_uid
unsigned off_p_ruid = 0x30; // proc_t::p_uid
unsigned off_p_rgid = 0x34; // proc_t::p_uid
unsigned off_p_ucred = 0xF8; // proc_t::p_ucred
unsigned off_p_csflags = 0x290; // proc_t::p_csflags
unsigned off_p_comm = 0x250; // proc_t::p_comm
unsigned off_p_textvp = 0x230; // proc_t::p_textvp
unsigned off_p_textoff = 0x238; // proc_t::p_textoff
unsigned off_p_cputype = 0x2A8; // proc_t::p_cputype
unsigned off_p_cpu_subtype = 0x2AC; // proc_t::p_cpu_subtype
...
unsigned off_itk_space = 0x300; // task_t::itk_space
...
unsigned off_csb_platform_binary = 0xA8; // cs_blob::csb_platform_binary
unsigned off_csb_platform_path = 0xAC; // cs_blob::csb_platform_path
